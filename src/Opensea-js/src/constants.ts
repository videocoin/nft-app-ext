...
export const CUSTOM_PROVIDER_URL = process.env.CUSTOM_PROVIDER_URL || 'http://localhost:8545'
...
export const API_BASE_CUSTOM = process.env.API_BASE_CUSTOM || 'http://localhost:3000'
export const SITE_HOST_MAINNET = 'https://opensea.io'
export const SITE_HOST_RINKEBY = 'https://rinkeby.opensea.io'
export const SITE_HOST_CUSTOM = process.env.SITE_HOST_CUSTOM || 'http://localhost:3000'
export const ORDERBOOK_PATH = process.env.ORDERBOOK_PATH || `/wyvern/v${ORDERBOOK_VERSION}`
export const API_PATH = process.env.API_PATH || `/api/v${ORDERBOOK_VERSION}`
