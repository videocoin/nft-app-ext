            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        exchange = process.env.WYVERN_EXCHANGE || wyvern_js_1.WyvernProtocol.getExchangeContractAddress(this._networkName);
                        return [2 /*return*/, {
                                exchange: exchange,
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 5:
                        ...
                        times = this._getTimeParameters(expirationTime);
                        exchange = process.env.WYVERN_EXCHANGE || wyvern_js_1.WyvernProtocol.getExchangeContractAddress(this._networkName);
                        target = process.env.WYVERN_ATOMICIZER || wyvern_js_1.WyvernProtocol.getAtomicizerContractAddress(this._networkName);
                        return [2 /*return*/, {
                                exchange: exchange,
                                maker: accountAddress,
                                taker: taker,
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        var computeOrderParams = function () {
            if ('asset' in order.metadata) {
                ...
                var atomicizer = process.env.WYVERN_ATOMICIZER || wyvern_js_1.WyvernProtocol.getAtomicizerContractAddress(_this._networkName);
                return {
                    target: atomicizer,
